...
class MyCustomFormState extends State<MyCustomForm> {
  ...
  final String nama = "ilham", sandi = "agusta";
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          TextFormField(
            ...
            validator: (value) {
              if (value.isEmpty) {
                return 'username Anda Valid, Masukkan User Anda Yang Benar';
              }
              return null;
            },
          ),
          ...
          TextFormField(
            ...
            validator: (value) {
              if (value.isEmpty) {
                return 'Password Anda Salah, Masukkan Sandi Anda Yang Benar ';
              }
              return null;
            },
          ),
              ...
              onPressed: () {
                if (namaController.text.trim() == nama &&
                  ...
                  Scaffold.of(context).showSnackBar(SnackBar(
                    content: Text(
                        'Maaf username Atau password Tidak Tersedia atau Valid'),
